...
public class EmailService extends Thread {
	...
	public void run() {
		...
		properties.put("mail.smtp.host", System.getProperty("email-project.mail.smtp.host")); //Servidor do gmail
		properties.put("mail.smtp.port", System.getProperty("email-project.mail.smtp.port")); //Porta do servidor
		...
		for (Email email : emails) {
			...
			try {
				...
				message.setFrom(new InternetAddress(System.getProperty("email-project.mail.from"))); //Quem esta enviando
